...
<head>
    ...
    <title>Enterprise Solutions - Enterprise AI Chatbot Platform</title>
    <meta name="description" content="Enterprise-grade AI solutions with advanced controls, compliance, and dedicated support">
    ...
    <header class="header">
        <div class="header-content">
            ...
            <nav class="nav" id="nav-menu">
                ...
                <a href="enterprise.html" class="active">
